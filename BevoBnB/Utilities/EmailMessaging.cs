...
namespace BevoBnB.Utilities
{
    public class EmailMessaging
    {
        public static void SendEmail(String emailSubject, String emailBody)
        {
            ...
            String strFromEmailAddress = "mis333k.group3.fa24@gmail.com";
            ...
            String strPassword = "ezeupkppgiqbladk";
            ...
            mm.Subject = "Team 03 - " + emailSubject;
            ...
            mm.To.Add(new MailAddress("antonio.meza@utexas.edu"));
